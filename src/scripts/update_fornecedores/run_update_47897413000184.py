...
Fornecedor: Jonatas Lucas Silva Gomes
CNPJ: 47.897.413/0001-84
...
MOCK_FORNECEDOR = Fornecedor(id=UUID('0e583364-ac84-4613-be88-be47ad0282f7'), endereco=Endereco(endereco='AZARIAS DE CARVALHO GAMA', numero='226', bairro='GRUTA DE LOURDES', cep=CEP(value='57052800', formatted=''), municipio=Municipio(nome='MACEIO', codigo_ibge=CodigoMunicipioIBGE(value='04302')), complemento=None, uf='ALAGOAS'), identificacao=FornecedorIdentificacao(cnpj=CNPJ(value='47897413000184', formatted='47.897.413/0001-84'), razao_social='LEADER IN COMPANY LTDA', nome_fantasia='LEADER IN COMPANY'), dados_cadastrais=FornecedorDadosCadastrais(opt_simples_nacional=True, vinculo_sebrae=VinculoSebraeEnum.Z, federacao=FederacaoEnum.NAO, cooperativa=False, codigo_retencao='1708', situacao_cadastral=SituacaoCadastralEnum.ATIVA, tipo_pessoa=TipoPessoaEnum.OS, tipo_contrato_social=None, porte=None), dados_contato=FornecedorDadosContato(ddd=DDD(value='82')))
...
if __name__ == "__main__":
    ...
    result = workflow.run()
    logger.info(
        "Finished run_update_47897413000184",
