...
MOCK_FORNECEDOR = Fornecedor(id=UUID('46e3b1f6-c4de-4aef-aed5-db1320e4278f'), endereco=Endereco(endereco='ALVARO OTACILIO', numero='3731', bairro='JATIUCA', cep=CEP(value='57036850', formatted=''), municipio=Municipio(nome='MACEIO', codigo_ibge=CodigoMunicipioIBGE(value='04302')), complemento='SALA 508, ED ITÁLIA BL A, JTR RESIDENCE', uf='ALAGOAS'), identificacao=FornecedorIdentificacao(cnpj=CNPJ(value='22935016000129', formatted='22.935.016/0001-29'), razao_social='VITTE EXCELENCIA OPERACIONAL LTDA', nome_fantasia='VITTE EXCELENCIA'), dados_cadastrais=FornecedorDadosCadastrais(opt_simples_nacional=True, vinculo_sebrae=VinculoSebraeEnum.Z, federacao=FederacaoEnum.NAO, cooperativa=False, codigo_retencao='1708', situacao_cadastral=SituacaoCadastralEnum.ATIVA, tipo_pessoa=TipoPessoaEnum.OS, tipo_contrato_social=None, porte=None), dados_contato=FornecedorDadosContato(ddd=DDD(value='82')))
...
if __name__ == "__main__":
    ...
    result = workflow.run()
    logger.info(
        "Finished run_update_22935016000129",
