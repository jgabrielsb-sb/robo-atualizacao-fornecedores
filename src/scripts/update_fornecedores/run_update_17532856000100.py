...
MOCK_FORNECEDOR = Fornecedor(id=UUID('b8135246-a462-4ba0-acac-4fc583b5cfc2'), endereco=Endereco(endereco='PARANA', numero='160', bairro='POCO', cep=CEP(value='57025123', formatted=''), municipio=Municipio(nome='MACEIO', codigo_ibge=CodigoMunicipioIBGE(value='04302')), complemento=None, uf='ALAGOAS'), identificacao=FornecedorIdentificacao(cnpj=CNPJ(value='17532856000100', formatted='17.532.856/0001-00'), razao_social='A. DE GUSMAO LYRA NETO LTDA', nome_fantasia='CLIMEX'), dados_cadastrais=FornecedorDadosCadastrais(opt_simples_nacional=True, vinculo_sebrae=VinculoSebraeEnum.Z, federacao=FederacaoEnum.NAO, cooperativa=False, codigo_retencao='1708', situacao_cadastral=SituacaoCadastralEnum.ATIVA, tipo_pessoa=TipoPessoaEnum.OS, tipo_contrato_social=None, porte=None), dados_contato=FornecedorDadosContato(ddd=DDD(value='82')))
...
if __name__ == "__main__":
    ...
    result = workflow.run()
    logger.info(
        "Finished run_update_17532856000100",
