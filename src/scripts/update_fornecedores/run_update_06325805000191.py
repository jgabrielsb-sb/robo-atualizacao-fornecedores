...
Fornecedor: Sol E Mar Transportes E Turismo Ltda
CNPJ: 06.325.805/0001-91
...
MOCK_FORNECEDOR = Fornecedor(id=UUID('ab3949ff-4092-4377-a7c4-801ed66a5612'), endereco=Endereco(endereco='ARAUJO BIVAR', numero='338', bairro='PAJUCARA', cep=CEP(value='57030035', formatted=''), municipio=Municipio(nome='MACEIO', codigo_ibge=CodigoMunicipioIBGE(value='04302')), complemento='SALA   02', uf=None), identificacao=FornecedorIdentificacao(cnpj=CNPJ(value='06325805000191', formatted='06.325.805/0001-91'), razao_social='SOL E MAR TRANSPORTE E TURISMO LTDA', nome_fantasia='SOL E MAR TURISMO'), dados_cadastrais=FornecedorDadosCadastrais(opt_simples_nacional=True, vinculo_sebrae=VinculoSebraeEnum.Z, federacao=FederacaoEnum.NAO, cooperativa=False, codigo_retencao='1708', situacao_cadastral=SituacaoCadastralEnum.ATIVA, tipo_pessoa=None, tipo_contrato_social=None, porte=None), dados_contato=FornecedorDadosContato(ddd=DDD(value='82')))
...
if __name__ == "__main__":
    ...
    result = workflow.run()
    logger.info(
        "Finished run_update_06325805000191",
