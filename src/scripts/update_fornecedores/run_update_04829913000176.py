...
Fornecedor: Pecuaria Intensiva Consultoria E Treinamento Ltda
CNPJ: 04.829.913/0001-76
...
MOCK_FORNECEDOR = Fornecedor(id=UUID('24fc0a90-5e85-40d1-bb89-e061af24346d'), endereco=Endereco(endereco='TRINTA DE OUTUBRO', numero='17', bairro='CENTRO', cep=CEP(value='57300380', formatted=''), municipio=Municipio(nome='ARAPIRACA', codigo_ibge=CodigoMunicipioIBGE(value='00300')), complemento='SALA  207', uf='ALAGOAS'), identificacao=FornecedorIdentificacao(cnpj=CNPJ(value='04829913000176', formatted='04.829.913/0001-76'), razao_social='PECUARIA INTENSIVA CONSULTORIA E TREINAMENTO LTDA', nome_fantasia='PECUARIA INTENSIVA'), dados_cadastrais=FornecedorDadosCadastrais(opt_simples_nacional=False, vinculo_sebrae=VinculoSebraeEnum.Z, federacao=FederacaoEnum.NAO, cooperativa=False, codigo_retencao='1708', situacao_cadastral=SituacaoCadastralEnum.ATIVA, tipo_pessoa=TipoPessoaEnum.OS, tipo_contrato_social=None, porte=None), dados_contato=FornecedorDadosContato(ddd=DDD(value='82')))
...
if __name__ == "__main__":
    ...
    result = workflow.run()
    logger.info(
        "Finished run_update_04829913000176",
