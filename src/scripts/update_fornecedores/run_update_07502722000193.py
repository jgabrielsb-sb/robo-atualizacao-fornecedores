...
Fornecedor: Idc Solucoes Empresa
CNPJ: 07.502.722/0001-93
...
MOCK_FORNECEDOR = Fornecedor(id=UUID('f0568f32-9ef2-4164-ac3a-efb7e5b9ed03'), endereco=Endereco(endereco='CIPRIANO JUCA', numero='78', bairro='POCO', cep=CEP(value='57025630', formatted=''), municipio=Municipio(nome='MACEIO', codigo_ibge=CodigoMunicipioIBGE(value='04302')), complemento='EDIF SANTA RITA SALA 101 ANDAR 1', uf=None), identificacao=FornecedorIdentificacao(cnpj=CNPJ(value='07502722000193', formatted='07.502.722/0001-93'), razao_social='IDC SOLUCOES EMPRESARIAIS LTDA', nome_fantasia='IDC SOLUCOES EMPRESA'), dados_cadastrais=FornecedorDadosCadastrais(opt_simples_nacional=True, vinculo_sebrae=VinculoSebraeEnum.Z, federacao=FederacaoEnum.NAO, cooperativa=False, codigo_retencao='1708', situacao_cadastral=SituacaoCadastralEnum.ATIVA, tipo_pessoa=TipoPessoaEnum.OS, tipo_contrato_social=None, porte=None), dados_contato=FornecedorDadosContato(ddd=DDD(value='82')))
...
if __name__ == "__main__":
    ...
    result = workflow.run()
    logger.info(
        "Finished run_update_07502722000193",
