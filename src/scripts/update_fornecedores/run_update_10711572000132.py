...
MOCK_FORNECEDOR = Fornecedor(id=UUID('d6ef2f6c-a504-4139-aba4-dd33c0551024'), endereco=Endereco(endereco='WALDEMAR LOUREIRO BERNARDES', numero='27', bairro='MANGABEIRAS', cep=CEP(value='57037320', formatted=''), municipio=Municipio(nome='MACEIO', codigo_ibge=CodigoMunicipioIBGE(value='04302')), complemento=None, uf='ALAGOAS'), identificacao=FornecedorIdentificacao(cnpj=CNPJ(value='10711572000132', formatted='10.711.572/0001-32'), razao_social='DISRUPY COMUNICACAO BRASIL LTDA', nome_fantasia='DISRUPY'), dados_cadastrais=FornecedorDadosCadastrais(opt_simples_nacional=False, vinculo_sebrae=VinculoSebraeEnum.Z, federacao=FederacaoEnum.NAO, cooperativa=False, codigo_retencao='1708', situacao_cadastral=SituacaoCadastralEnum.ATIVA, tipo_pessoa=TipoPessoaEnum.OS, tipo_contrato_social=None, porte=None), dados_contato=FornecedorDadosContato(ddd=DDD(value='55')))
...
if __name__ == "__main__":
    ...
    result = workflow.run()
    logger.info(
        "Finished run_update_10711572000132",
