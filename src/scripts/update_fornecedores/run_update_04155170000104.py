...
MOCK_FORNECEDOR = Fornecedor(id=UUID('a06a6aec-0a8a-4f76-9bb3-4656bdf4b6ba'), endereco=Endereco(endereco='DR. ROCHA CAVALCANTE', numero='181', bairro='JARAGUA', cep=CEP(value='57025290', formatted=''), municipio=Municipio(nome='MACEIO', codigo_ibge=CodigoMunicipioIBGE(value='04302')), complemento=None, uf=None), identificacao=FornecedorIdentificacao(cnpj=CNPJ(value='04155170000104', formatted='04.155.170/0001-04'), razao_social='SERVICO NACIONAL DE APREDIZAGEM RURAL SENAR -AR/AL', nome_fantasia='SENAR AR/AL'), dados_cadastrais=FornecedorDadosCadastrais(opt_simples_nacional=False, vinculo_sebrae=VinculoSebraeEnum.Z, federacao=FederacaoEnum.NAO, cooperativa=False, codigo_retencao='1708', situacao_cadastral=SituacaoCadastralEnum.ATIVA, tipo_pessoa=TipoPessoaEnum.OS, tipo_contrato_social=None, porte=None), dados_contato=FornecedorDadosContato(ddd=DDD(value='82')))
...
if __name__ == "__main__":
    ...
    result = workflow.run()
    logger.info(
        "Finished run_update_04155170000104",
